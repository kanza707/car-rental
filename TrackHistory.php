...
if (empty($_SESSION['user_username']) || empty($_SESSION['user_useremail'])) {
...
?>
  ...
  <head>
    <title>Cars - Track Booking</title>
    <meta charset="utf-8">
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start">
          <div class="col-md-9 ftco-animate pb-5">
            ...
            <h1 class="mb-3 bread">Track Orders</h1>
          </div>
        </div>
      </div>
    </section>
            ...
            <table class="table table-striped">
              <thead>
                <tr>
                  ...
                  <th scope="col">Drop offline_pin Point</th>
              ...
              <tbody>
                ...
                $sqlshowuser = "SELECT * FROM `bookcar` 
                    ...
                    bookcar.Userid_FK = userregistrtation.Userid where  Userid_FK = $uid";
                $result  = mysqli_query($conn, $sqlshowuser);
                if (mysqli_num_rows($result) > 0) {
                  while ($row = mysqli_fetch_assoc($result)) {
                ?>
                    <tr>
                      <th scope="row"><?php echo $row['Car_Name'] ?></th>
                      ...
                      <td>
                        ...
                        <?php
                        if ($row['Carstatus'] == "Booked") {
                          echo "<span class='badge badge-warning'>Progress</span>";
                        } else {
                          echo "<span class='badge badge-success'>Booking Completed</span>";
                        }
                        ?>
